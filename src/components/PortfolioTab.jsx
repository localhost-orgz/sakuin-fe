        ...
        <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 relative z-10">
          <div className="text-left">
            ...
            <p className="text-sm text-white/70 font-medium mt-1">
              Manage your accounts, check asset valuation, and track specific
              financial goals.
            </p>
          </div>
        </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative z-10 text-left">
                      <h4 className="font-extrabold text-sm opacity-90 truncate max-w-[180px]">
                        {wallet.name}
                      </h4>
              ...
              {goals.map((goal) => {
                ...
                return (
                  <div
                    key={goal.id}
                    onClick={() =>
                      onNavigateToGoal && onNavigateToGoal(goal._id || goal.id)
                    }
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h4 className="font-extrabold text-sm text-slate-800 truncate max-w-[150px]">
                          {goal.name}
                        </h4>
          ...
          <div className="bg-white rounded-3xl shadow-xl w-full max-w-lg overflow-hidden animate-slide-up border border-slate-100/50">
            <div className="px-6 py-5 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
              <div className="flex items-center gap-2">
                <div
                  style={{
                    backgroundColor: getWalletTheme(
                      selectedWallet.themeId || selectedWallet.color || "ocean",
                    ).accentColor,
                  }}
                  className="w-4 h-4 rounded-md"
                />
                <h3 className="font-extrabold text-base text-slate-800">
                  Wallet Profile: {selectedWallet.name}
                </h3>
              </div>
              <button
                  ...
                  <div className="max-h-48 overflow-y-auto divide-y divide-slate-100 border border-slate-100 rounded-2xl bg-white custom-scrollbar">
                    {transactions
                      .filter(
                        (t) =>
                          t.wallet_id ===
                          (selectedWallet._id || selectedWallet.id),
                      )
                      .map((tx) => {
                        ...
                        return (
                          <div
                            key={tx._id || tx.id}
                            className="flex justify-between items-center py-3 px-4 hover:bg-slate-50/30"
                          >
                            <div>
                            ...
                            <span
                              className={`text-xs font-bold ${isExpense ? "text-rose-500" : "text-[#00BC7D]"}`}
                            >
          ...
          <div className="bg-white rounded-3xl shadow-xl w-full max-w-md overflow-hidden animate-slide-up border border-slate-100/50">
            <div className="px-6 py-5 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-extrabold text-base text-slate-800">
                  Saving Goal Details: {selectedGoal.name}
                </h3>
              </div>
              <button
